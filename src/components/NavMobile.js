...
function BarNav(props) {
   ...
   return ( 
     <div className="w3-bar-block w3-margin-bottom w3-row" 	style={ dark ? styles.titleDark : styles.titleLight }	>
...
function NavElement(props) {
   ...
   return(
      <div hidden={ hiddenNav } className="w3-animate-top w3-margin-bottom w3-row" style={ props.dark ? styles.darkNav : styles.lightNav }>                                     
     		<div className="w3-col s6">
     			<props.link to="/theme" className={ `${ option === 'theme' ? 'w3-blue' : '' } w3-round w3-bar-item w3-block w3-btn w3-left-align ` }>
     				<BsCircleHalf className="w3-radio"/>
     			   <span className="w3-margin-left w3-label">Thème</span>
     			</props.link>
   				
   			<props.link to="/note" className={ `${ option === 'note' ? 'w3-blue' : '' } w3-round w3-bar-item w3-block w3-btn w3-left-align ` }>
     					<BsBook className="w3-radio"/>
     					<span className="w3-margin-left w3-label">Exercice</span>
     			</props.link>
     			
   			<props.link to="/about" className={ `${ option === 'about' ? 'w3-blue' : '' } w3-round w3-bar-item w3-block w3-btn w3-left-align ` }>
     		...
     		<div className="w3-col s6" >
      	  	<props.link to="/home" 
      	  	   className={ `${ option === 'home' ? 'w3-blue' : ''} w3-btn w3-block w3-right-align w3-round` }
  		         >
